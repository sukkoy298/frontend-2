        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <input
              ...
              placeholder="0.00"
              className="w-full bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg py-3.5 px-4 pr-28 text-lg text-zinc-900 dark:text-white font-mono outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500/30 transition-all"
            />
